...
<?php $__env->startSection('post-css'); ?>
...
<?php $__env->startSection('pre-js'); ?>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/diag.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('post-js'); ?>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Strings.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Dates.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/poster.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Antispam.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/ForefrontAntispam.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/2047.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Other.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Received.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Summary.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Headers.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/Table.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/stephenegriffin/MHA/StandAlone.js')); ?>"></script>
<?php $__env->stopSection(); ?>
